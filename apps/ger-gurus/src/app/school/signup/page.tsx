...
export default function Index() {
  ...
  return (
    <main data-theme="light" className="flex flex-col gap-6 items-center pt-[140px] h-[100vh]">
      {step === '1' && (
        <>
      ...
      {step === '3' && (
        <>
          <div className="py-2 font-medium text-2xl text-center">Таны бүртгэл амжилттай баталгаажлаа</div>
          <div className="w-[400px] flex flex-col gap-5">
            <div className="flex justify-between px-10">
