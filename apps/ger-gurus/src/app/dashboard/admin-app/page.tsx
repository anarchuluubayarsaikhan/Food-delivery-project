export default function Page() {
  return (
    <main className="flex flex-col justify-center text-center felx-wrap">
      <h1 className="text-primary text-2xl"> Админ Удирдлагын Хуудаст тавтай морил! </h1>
      <p className="text-base-content"> Энд та нэгж хичээл, бүлэг хичээлүүдээ үүсгэж, удирдах, мөн вэбсайтдаа өөрчлөлт оруулах боломжтой. </p>
